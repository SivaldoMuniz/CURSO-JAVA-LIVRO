import  java.io.PrintStream;
  ...
  public class Involucro {
	...
	Long lg2 = new Long ("-92233703685477807");
	Float fl1 = new Float (3.4028+38f);
	Float fl2 = new Float (1.7976E+38);
	...
	saida.println("it2 =\t" + it2.intValue());
  	saida.println("lg1 =\t" + lg1.intValue());
	saida.println("lg2 =\t" + lg2.intValue());
